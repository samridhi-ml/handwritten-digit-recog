...
%
    ...
    for i = 1:m,
      ...
      J = J + (-log(x_vec)*y_vec - log(1-x_vec)*(1-y_vec));
    end
    ...
    ThetaVec = [Ttheta1(:) ; Ttheta2(:)];
    
    ThetaVec = ThetaVec.*ThetaVec;
    
    J = J + (sum(ThetaVec)*lambda)/(2*m);
